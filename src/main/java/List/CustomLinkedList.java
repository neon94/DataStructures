...
public class CustomLinkedList<T> {
    ...
    public static void main(String[] args) {
        ...
        CustomLinkedList<Integer> head = new CustomLinkedList<Integer>(1);

        head.add(new CustomLinkedList<Integer>(2));
        head.add(new CustomLinkedList<Integer>(3));
        head.add(new CustomLinkedList<Integer>(4));
